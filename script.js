// QUESTION 1
const ans1Div = document.getElementById("answer1");
const que1btn = document.getElementById("question1");
que1btn.onclick = function () {
	if(ans1Div.style.display !== "none"){
		ans1Div.style.display = "none";
	}else{
		ans1Div.style.display = "block";
	}
};
// QUESTION 2
